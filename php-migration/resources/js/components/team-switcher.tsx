            ...
            <DropdownMenuTrigger asChild>
                <Button
                    ...
                    className={
                        inHeader
                            ? 'h-8 gap-1 px-2'
                            : 'h-auto w-full justify-start gap-2 rounded-lg border-outline-variant bg-surface-container-low px-3 py-2 has-[>svg]:px-3 hover:bg-surface-container-high data-[state=open]:bg-surface-container-high'
                    }
                >
                    <Users
                        className={
