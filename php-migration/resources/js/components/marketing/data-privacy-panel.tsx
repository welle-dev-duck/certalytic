            ...
            <div className="space-y-4">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        >
                            All candidate data is processed exclusively within
                            EU jurisdiction - Hetzner EU datacenters
                            (Germany/Finland) and Mistral AI La Plateforme
                            (Paris, France). No US cloud compute or CDN in the
                            data path.
                        </p>
                    </div>
                </div>
                <div className="flex items-center justify-between border-t border-border py-2.5">
                    <div>
                        ...
                        >
                            Candidate data is never used to train, fine-tune, or
                            improve Mistral foundation models.
                        </p>
                    </div>
                    <span
                        className={cn(
