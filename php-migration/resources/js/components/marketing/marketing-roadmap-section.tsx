...
export default function MarketingRoadmapSection() {
            ...
            <div className="mx-auto max-w-6xl px-6">
                <div className="mb-10 max-w-2xl">
                    ...
                    <p className="mt-3 text-muted-foreground">
                        What we&apos;re building next- approximate delivery
                        quarters based on current engineering priorities.
                    </p>
                </div>

                <ol className="grid gap-4 md:grid-cols-2">
                    {marketing.roadmap.map((item, index) => (
                        <li
                            key={item.title}
