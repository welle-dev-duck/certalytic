...
export type ScreeningLimits = {
    cv_max_kilobytes: number;
    cv_text_max_words: number;
    cv_text_max_characters: number;
    transcript_text_max_words: number;
    transcript_text_max_characters: number;
    transcript_file_max_kilobytes?: number;
    ...
    return z
        .object({
            ...
            email: z
                ...
                .optional()
                .or(z.literal('')),
            roleId: z.number({ error: 'Select a role.' }).nullable(),
