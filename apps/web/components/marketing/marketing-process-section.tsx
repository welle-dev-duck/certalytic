...
const processSteps = [
  {
    ...
    screenshots: [
      { filename: "process-create-role.png", label: "Role creation form" },
    ],
  },
  {
    step: 2,
    ...
    screenshots: [
      { filename: "process-candidate-details.png", label: "Step 1 · Candidate & CV" },
      {
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-14 max-w-2xl">
          ...
          <p className="mt-3 text-muted-foreground">
            Certalytic fits at the end of your interview loop. Create the role,
            screen each finalist, export the evidence-backed report before anyone
