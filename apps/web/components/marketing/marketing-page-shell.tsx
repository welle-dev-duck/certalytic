...
export function MarketingPageShell({ children }: { children: ReactNode }) {
  return (
    <div className="h-[calc(100dvh-var(--banner-height,0px)-var(--impersonation-banner-height,0px))] min-h-0 overflow-x-clip overflow-y-auto overscroll-y-contain bg-background text-foreground">
