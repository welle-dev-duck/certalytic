      ...
      <div className="brand-gradient relative hidden flex-col justify-between overflow-hidden p-10 text-white lg:flex">
        ...
        <div className="relative z-10 max-w-md space-y-4">
          ...
          <p className="text-sm leading-relaxed text-white/80">
            Build the integrity dossier before the offer letter — EU-sovereign
            CV, transcript, and profile cross-checks with cited flags, not
            automated verdicts.
          </p>
        </div>
        <p className="relative z-10 text-xs tracking-wide text-white/55 uppercase">
          {COMPANY.name} · Decision support only
        </p>
      </div>
